...
_MAX_TRUNCATION_LENGTH = 150
_TRUNCATED_LENGTH = 140
...
class LLMSummarizer:
    ...
    async def summarize(self, event: VoiceCopilotEvent) -> NarrationEvent:
    ...
    def _truncate(self, event: VoiceCopilotEvent) -> NarrationEvent:
