...
class TemplateEngine:
    ...
    def render(self, event: VoiceCopilotEvent) -> NarrationEvent:
    ...
    def render_batch(self, events: list[VoiceCopilotEvent]) -> NarrationEvent:
    ...
    def _render_text(self, event: VoiceCopilotEvent) -> str:
    ...
    def _render_tool_executed(self, event: VoiceCopilotEvent) -> str:
    ...
    def _render_agent_blocked(self, event: VoiceCopilotEvent) -> str:
    ...
    def _render_agent_stopped(self, event: VoiceCopilotEvent) -> str:
