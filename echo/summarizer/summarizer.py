...
from echo.summarizer.llm_summarizer import LLMSummarizer
...
class Summarizer:
    ...
    async def _process_event(self, event: EchoEvent) -> None:
    ...
    async def _handle_tool_executed(self, event: EchoEvent) -> None:
    ...
    async def _handle_agent_message(self, event: EchoEvent) -> None:
    ...
    async def _handle_agent_blocked(self, event: EchoEvent) -> None:
    ...
    async def _handle_template_event(self, event: EchoEvent) -> None:
